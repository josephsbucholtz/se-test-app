  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex h-9 items-center gap-1.5 rounded-md px-3 text-sm font-medium italic text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground"
      >
        {currentLabel}
        <ChevronDown
